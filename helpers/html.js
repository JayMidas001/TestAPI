const signUpTemplate = (verifyLink, firstName) => {
    return `
      ...
      <head>
        ...
        <title>Welcome to Jay Midas Corp!</title>
        <style>
          body {
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1>Welcome to Jay Midas Corp!</h1>
          </div>
          <div class="content">
            <p>Hello ${firstName},</p>
  ...
  <head>
      <meta charset="UTF-8">
      <title>Welcome to Midas Corp</title>
      <style>
      body {
        font-family: Arial, sans-serif;
        line-height: 1.6;
  ...
  const passwordChangeTemplate = (firstName) => {
    return `
      <!DOCTYPE html>
      <html lang="en">
      <head>
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1>Password Changed Successfuuly</h1>
          </div>
          <div class="content">
            <p>Hello ${firstName},</p>
  ...
  module.exports = { signUpTemplate, verifyTemplate, forgotPasswordTemplate, passwordChangeTemplate};
